...
const textSlideOverrides: Array<Partial<TextSlide>> = [
  {
    ...
    body:
      "Terminal AI integrates advanced AI capabilities directly into your terminal, enhancing productivity and workflow.",
    image: {
  ...
  },
  {
    ...
    body:
      "Terminal AI provides features like code generation, error debugging, and command suggestions to streamline your tasks.",
  },
  {
    title: "Code Generation",
    subtitle: "Automate coding tasks",
    body:
      "Generate boilerplate code, functions, or entire modules with simple prompts, saving time and effort.",
    image: {
  ...
  },
  {
    ...
    body:
      "Terminal AI helps you quickly identify errors in your code and suggests possible fixes, reducing debugging time.",
    image: {
  ...
  },
  {
    ...
    body:
      "Get intelligent command suggestions based on your workflow, making it easier to navigate and execute tasks.",
  },
  {
    title: "Customization",
    subtitle: "Tailor Terminal AI to your needs",
    body:
      "Customize Terminal AI's behavior and responses to fit your specific development style and requirements.",
  },
  {
    title: "Integration",
    subtitle: "Works with your existing tools",
    body:
      "Seamlessly   integrate Terminal AI with popular development tools and environments for a smooth experience.",
    image: {
  ...
  },
  {
    ...
    body:
      "Follow our simple setup guide to get Terminal AI up and running in your terminal environment quickly.",
  },
  {
    title: "Future Developments",
    subtitle: "What's next for Terminal AI",
    body:
      "Stay tuned for upcoming features and improvements as we continue to enhance Terminal AI based on user feedback.",
    image: {
